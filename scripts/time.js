...
const schedules = {
    A: {
        ...
        lunch: { start: 1110, end: 1140, name: "A Lunch" },
        4: { start: 1140, end: 1240, name: "Period 4" },
        5: { start: 1240, end: 1340, name: "Period 5" },
    ...
    B: {
        ...
        2: { start: 920, end: 1010, name: "Period 2" },
        3: { start: 1015, end: 1105, name: "Period 3" },
        4: { start: 1110, end: 1210, name: "Period 4" },
        lunch: { start: 1210, end: 1240, name: "B Lunch" },
        5: { start: 1240, end: 1340, name: "Period 5" },
        WIN: { start: 1340, end: 1410, name: "WIN" },
        6: { start: 1415, end: 1505, name: "Period 6" },
        7: { start: 1510, end: 1600, name: "Period 7" },
    ...
    C: {
        ...
        3: { start: 1015, end: 1105, name: "Period 3" },
        4: { start: 1110, end: 1210, name: "Period 4" },
        "5A": { start: 1210, end: 1240, name: "Period 5" },
        lunch: { start: 1240, end: 1310, name: "C Lunch" },
        "5B": { start: 1310, end: 1340, name: "Period 5" },
        WIN: { start: 1340, end: 1410, name: "WIN" },
        6: { start: 1415, end: 1505, name: "Period 6" },
        7: { start: 1510, end: 1600, name: "Period 7" },
    },
    D: {
        ...
        3: { start: 1015, end: 1105, name: "Period 3" },
        4: { start: 1110, end: 1210, name: "Period 4" },
        5: { start: 1210, end: 1310, name: "Period 5" },
        lunch: { start: 1310, end: 1340, name: "D Lunch" },
        WIN: { start: 1340, end: 1410, name: "WIN" },
        6: { start: 1415, end: 1505, name: "Period 6" },
        7: { start: 1510, end: 1600, name: "Period 7" },
    }
